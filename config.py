...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8099261976:AAG6bsZIIL4Se3lu4a6wzH_bVX12HRAvLkU")
...
SHORT_API = os.environ.get("SHORTNER_API", "3a1b73d6f047ee291b8e9592f5cc13fb1aea6b54")
